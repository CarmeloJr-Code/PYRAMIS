...
class Order extends Model
{
    ...
    /**
     * Limit the query to orders still to be dealt with.
     *
     * The same set the cashier queue shows by default, named here so the
     * dashboard counts the queue rather than its own idea of one.
     *
