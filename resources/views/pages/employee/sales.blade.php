...
<section class="w-full">
    ...
    <flux:text class="mt-2">{{ __('Sales transactions, customer orders and expense recording.') }}</flux:text>

    <flux:separator variant="subtle" class="my-6" />

    <flux:callout icon="wrench-screwdriver">
        <flux:callout.heading>{{ __('Not built yet') }}</flux:callout.heading>
        <flux:callout.text>{{ __('This section arrives in Phase 4.') }}</flux:callout.text>
    </flux:callout>
</section>
